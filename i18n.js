...
const translations = {
    ko: {
        ...
        'onboarding.welcomeDesc': '마이맵봇에서 더 스마트한 일상을\n경험해보세요',
        'onboarding.feature1': '실시간 주차장 정보',
        'onboarding.feature2': 'AI 여행 플래너',
        'onboarding.feature3': '주변 맛집 탐색',
        'onboarding.personalize': '맞춤 설정',
        'onboarding.personalizeDesc': '관심 있는 서비스를 선택하세요',
        'onboarding.interestParking': '주차장',
        'onboarding.interestRoute': '경로 안내',
        'onboarding.interestTravel': '여행',
        'onboarding.interestDining': '맛집',
        'onboarding.transportTitle': '주요 이동 수단',
        'onboarding.transportCar': '자동차',
        'onboarding.transportTransit': '대중교통',
        'onboarding.transportWalk': '도보',
        'onboarding.transportBike': '자전거',
        'onboarding.ready': '준비 완료!',
        'onboarding.readyDesc': '이제 마이맵봇을 시작해보세요',
        'onboarding.actionParking': '주차장 찾기',
        'onboarding.actionTravel': '여행 계획하기',
        'onboarding.actionDining': '맛집 찾기',
        'onboarding.tipsTitle': '💡 유용한 팁',
        'onboarding.tip1': '챗봇에게 음성으로 명령할 수 있어요',
        'onboarding.tip2': '자주 가는 장소를 즐겨찾기 해보세요',
        'onboarding.tip3': '알림을 설정하면 더 편리해요',
        'onboarding.prev': '이전',
        'onboarding.next': '다음',
        'onboarding.finish': '시작하기',
        'onboarding.skipConfirm': '온보딩을 건너뛰시겠습니까?\n나중에 설정에서 다시 볼 수 있습니다.',
        'onboarding.congratulations': '환영합니다! 마이맵봇을 시작해보세요'
    },
    en: {
        ...
        'onboarding.welcomeDesc': 'Experience a smarter daily life\nwith MyMapBot',
        'onboarding.feature1': 'Real-time Parking Info',
        'onboarding.feature2': 'AI Travel Planner',
        'onboarding.feature3': 'Nearby Restaurant Search',
        'onboarding.personalize': 'Personalize',
        'onboarding.personalizeDesc': 'Select services you\'re interested in',
        'onboarding.interestParking': 'Parking',
        'onboarding.interestRoute': 'Route',
        'onboarding.interestTravel': 'Travel',
        'onboarding.interestDining': 'Dining',
        'onboarding.transportTitle': 'Primary Transport',
        'onboarding.transportCar': 'Car',
        'onboarding.transportTransit': 'Transit',
        'onboarding.transportWalk': 'Walk',
        'onboarding.transportBike': 'Bike',
        'onboarding.ready': 'Ready!',
        'onboarding.readyDesc': 'Let\'s start using MyMapBot',
        'onboarding.actionParking': 'Find Parking',
        'onboarding.actionTravel': 'Plan Trip',
        'onboarding.actionDining': 'Find Restaurant',
        'onboarding.tipsTitle': '💡 Useful Tips',
        'onboarding.tip1': 'You can give voice commands to the chatbot',
        'onboarding.tip2': 'Bookmark your favorite places',
        'onboarding.tip3': 'Set up notifications for convenience',
        'onboarding.prev': 'Previous',
        'onboarding.next': 'Next',
        'onboarding.finish': 'Get Started',
        'onboarding.skipConfirm': 'Skip onboarding?\nYou can view it again in settings.',
        'onboarding.congratulations': 'Welcome! Let\'s get started with MyMapBot'
    },
    ja: {

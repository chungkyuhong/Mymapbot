...
**AI 기반 스마트 맵 플랫폼** - 주차, 경로, 민원, 안내, 예약, 여행 추천, 여행 플래너 기능을 통합한 올인원 솔루션

> 🚀 미래지향적 디자인 | 🎯 실시간 POI 데이터 | 🤖 AI 기반 추천
...
📖 **상세 문서**: [TRAVEL_FEATURES.md](./TRAVEL_FEATURES.md)

### 7. 📅 여행 플래너 (NEW!)
- **여행 계획 관리**
  - 여행 제목, 목적지, 일정 설정
  - 예산 및 인원 관리
  - 계획 상태 추적 (계획중/확정/완료/취소)
...
📖 **상세 문서**: [PLANNER_GUIDE.md](./PLANNER_GUIDE.md)
